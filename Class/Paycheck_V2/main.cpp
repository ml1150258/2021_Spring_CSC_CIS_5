...
int main(int argc, char** argv) {
    ...
    float ovrTime=hrsWrkd>OVRTIME?//Creating a utility variable for Overtime
                  (hrsWrkd-OVRTIME)*payRate://Additional Overtime Amount
                  0;                        //Already set Paycheck to straight time
    payChck+=ovrTime;//Added the overtime here to the paycheck
