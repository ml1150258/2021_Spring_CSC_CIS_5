...
int main(int argc, char** argv) {
    //Declare variables
    const float PNTCOV=340;//The coverage of 1 can of paint in ft^2
    float height,//Height of the fence in feet
          length,//Length of the fence in feet
         srfArea;//Surface Area in ft^2
    unsigned char numCans;//Number of cans of paint 1 byte integer
    
    //Initialize variables
    cout<<"This program calculates Number of Cans required to Paint A Fence!"<<endl;
    cout<<"Input the Height and Length of a Fence in ft"<<endl;
    cin>>height>>length;
    ...
    cout<<"A fence having dimensions Length = "<<length<<"ft and Height = "
            <<height<<"ft"<<endl;
    cout<<"Requires "<<static_cast<int>(numCans)<<" cans of paint!"<<endl;
